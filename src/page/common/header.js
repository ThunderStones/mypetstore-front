...
let header = {
    ...
    setToken: function () {
        ...
        console.log(token);
        if (token) {
            _account_service._axios.defaults.headers.common['Authorization'] = token;
            _order_service._axios.defaults.headers.common['Authorization'] = token;
            _cart_service._axios.defaults.headers.common['Authorization'] = token;
            _address_service._axios.defaults.headers.common['Authorization'] = token;
        }
    },
